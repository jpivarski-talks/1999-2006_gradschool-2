...
s0max=computer_eps*s0max*s0max;
 if(Q1!=NULL) free(Q1);
 if(Q2!=NULL) free(Q2);
 Q1=(real*)malloc(sizeof(real)*14);
 Q2=(real*)malloc(sizeof(real)*14);
Q1[13]=va[6]*va[6]- sqrMom("\1\5",momenta);
Q1[12]=- sqrMom("\1\5",momenta);
Q1[11]=va[13]*va[13]- sqrMom("\2\3",momenta);
Q1[10]=va[11]*va[11]- sqrMom("\1\3",momenta);
DMASS[3]=va[11];
DWIDTH[3]=va[12];
Q1[3]=va[11]*va[11]- sqrMom("\3\4",momenta);
Q1[9]=va[9]*va[9]- sqrMom("\3\4",momenta);
Q1[8]=- sqrMom("\3\4",momenta);
DMASS[2]=va[28];
DWIDTH[2]=va[8];
...
Q1[7]=- sqrMom("\4\5",momenta);
Q1[6]=va[9]*va[9]- sqrMom("\1\3",momenta);
Q1[5]=va[28]*va[28]- sqrMom("\2\4",momenta);
