...
C[21]=+9*S[4];
S[5]=va[1]*va[1]*va[1]*va[1];
C[22]=+2*va[27]*va[26]*va[21]*va[20]*S[5];
}
S[0]=va[14]*va[14];
TOTNUM=+C[22]*S[0];
...
TOTDEN=+C[21]*S[1];
S[2]=va[28]*va[28];
RNUM=+S[2]*(S[2]*(DP[7]*(DP[1]*(16*(DP[5]-DP[3])+C[12])+DP[3]*(C[13]-4*
 S[2])-C[15]-C[14]*DP[5])+DP[0]*(-C[1]-C[9]*S[2]-C[20]*DP[1]-C[16]*DP[8])+
...
result=RNUM*(TOTNUM/TOTDEN)*Q1[4]*Q1[5]*Q1[9]*Q1[6]*Q0[1]*Q0[2]*Q0[3];
