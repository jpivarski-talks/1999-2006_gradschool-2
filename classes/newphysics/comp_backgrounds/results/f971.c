...
C[8]=+81*S[2];
S[3]=va[20]*va[20];
S[4]=va[1]*va[1]*va[1]*va[1]*va[1]*va[1];
C[9]=+8*S[3]*S[4];
}
TOTNUM=+C[9];
S[0]=va[28]*va[28];
TOTDEN=+C[8]*S[0];
RNUM=+S[0]*(DP[0]*(2*(DP[5]*(DP[6]+DP[7])+DP[8]*(DP[3]+DP[4])-DP[9]*S[0])+
 C[2]*(DP[1]+DP[2])+4*(-DP[6]*DP[4]-DP[7]*DP[3])-C[4]-C[0]*S[0]-C[3]*DP[0]-
 C[6]*DP[9])+DP[4]*(DP[6]*(S[0]-C[6])+DP[7]*(C[5]-4*DP[1])+C[6]*DP[8])+
 DP[2]*(C[1]-4*DP[6]*DP[3]+C[6]*DP[9])+DP[7]*(DP[3]*(S[0]-C[6])+C[6]*
