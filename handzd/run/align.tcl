...
# Include this to generate your own tracks (be sure to include FATable<CollatedRawZDHit> in your pds files!)
...
module sel ../build_OSF1/shlib/ZDAlignmentMod
param ZDAlignmentMod geom nov21.zdgeomalignment
