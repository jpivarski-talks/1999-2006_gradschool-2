...
file out ../pds/alltracks$env(USER_RUN).pds {event{DBEventHeader DBTrackerValues FATable<TRTrack> FATable<TRHelixPionFit> FATable<TRPionQuality> FATable<TRSeedTrack> FATable<TRSeedTrackQuality> SeedTrackZDHitLattice PionFitZDHitLattice FATable<CalibratedZDHit> BunchDecision FATable<CollatedRawZDHit>}}
