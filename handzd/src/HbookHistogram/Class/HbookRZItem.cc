...
// $Id: HbookRZItem.cc,v 1.2 2002/09/11 15:34:18 mrs43 Exp $
//
// Revision history
//
// $Log: HbookRZItem.cc,v $
// Revision 1.2  2002/09/11 15:34:18  mrs43
// added endl to report statements
//
...
static const char* const kIdString  = "$Id: HbookRZItem.cc,v 1.2 2002/09/11 15:34:18 mrs43 Exp $";
  ...
  m_linkToFile( new FileHook )
{
  ...
  if ( ! ( ( pFile->hookUpHbookRZItem( this ) ) &&
    ...
    report ( EMERGENCY,
	     kFacilityString )
		<< "Can not link an Ntuple to the given file" << endl;
    exit( 1 );
  }
