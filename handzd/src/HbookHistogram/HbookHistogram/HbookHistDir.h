...
// $Id: HbookHistDir.h,v 1.9 2003/03/12 21:51:43 vk Exp $
//
// Revision history
//
// $Log: HbookHistDir.h,v $
// Revision 1.9  2003/03/12 21:51:43  vk
// Add truncated algorithm for HBOOK/Directory names
//
// Revision 1.8  2003/01/17 20:35:37  cdj
...
class HbookHistDir : public HIHistDir
{
   ...
   private:
      ...
      string HbookHistDir::makeShortName(const string& iPath) const;
      string HbookHistDir::removeVowel(const string& iName, const int& Size) const;
      string HbookHistDir::removeLower(const string& iName, const int& Size) const;
      string HbookHistDir::removeAllLower(const string& iName, const int& Size) const;
