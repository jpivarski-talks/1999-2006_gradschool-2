...
//
// $Id: hbook_functions.h,v 1.8 2003/11/03 20:40:29 mccann Exp $
//
// $Log: hbook_functions.h,v $
// Revision 1.8  2003/11/03 20:40:29  mccann
...
extern void hreset_( const FInteger* pID, const FChar* pChTitl, const FInteger nChar );
