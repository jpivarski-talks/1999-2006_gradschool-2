...
// $Id: HbookHistogramModule.cc,v 1.7 2003/01/10 20:26:07 cdj Exp $
//
// Revision history
//
// $Log: HbookHistogramModule.cc,v $
// Revision 1.7  2003/01/10 20:26:07  cdj
// use stringstream if available
//
// Revision 1.6  2002/12/06 21:11:19  cdj
// explicitly include strstream.h
//
...
#else
#if !defined(USE_STRSTREAM_RATHER_THAN_STRINGSTREAM_BUG)
   ostringstream logicalUnitNumber; 
#else
