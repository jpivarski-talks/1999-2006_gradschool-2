...
// $Id: HVHistogram2DPlotter.cc,v 1.5 2003/11/11 15:33:32 cdj Exp $
//
// Revision history
//
// $Log: HVHistogram2DPlotter.cc,v $
// Revision 1.5  2003/11/11 15:33:32  cdj
// avoid integral division
//
...
static const char* const kIdString  = "$Id: HVHistogram2DPlotter.cc,v 1.5 2003/11/11 15:33:32 cdj Exp $";
...
HVHistogram2DPlotter::retrieveNewValues()
{
   ...
   const double max_width( floor( ( contentsRect().width() - 150 ) / double(numberOfChannelsX) ) );
   const double max_height( floor( ( contentsRect().height() - 112 ) / double(numberOfChannelsY) ) );
