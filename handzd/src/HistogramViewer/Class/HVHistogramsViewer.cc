...
// $Id: HVHistogramsViewer.cc,v 1.6 2003/11/10 21:31:49 cdj Exp $
//
// Revision history
//
// $Log: HVHistogramsViewer.cc,v $
// Revision 1.6  2003/11/10 21:31:49  cdj
// updated to qwt version 4.1 interface
//
...
static const char* const kIdString  = "$Id: HVHistogramsViewer.cc,v 1.6 2003/11/10 21:31:49 cdj Exp $";
...
HVHistogramsViewer::createPlot(const HIHist1D* iHist)
{
   ...
   plotter->setCanvasBackground( white );
