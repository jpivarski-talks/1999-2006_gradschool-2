...
// $Id: HistogramViewerProc.cc,v 1.2 2001/10/30 21:11:37 cdj Exp $
//
// Revision history
//
// $Log: HistogramViewerProc.cc,v $
// Revision 1.2  2001/10/30 21:11:37  cdj
// removed a memory bloating where we no longer make a QTimer per event
//
...
static const char* const kIdString  = "$Id: HistogramViewerProc.cc,v 1.2 2001/10/30 21:11:37 cdj Exp $";
