...
// $Id: MinuitInterface.cc,v 1.7 2003/11/10 20:58:32 mccann Exp $
//
// Revision history
//
// $Log: MinuitInterface.cc,v $
// Revision 1.7  2003/11/10 20:58:32  mccann
// Fixed off-by-one error in indexing parameters on the C++ side
//
...
static const char* const kIdString  = "$Id: MinuitInterface.cc,v 1.7 2003/11/10 20:58:32 mccann Exp $";
