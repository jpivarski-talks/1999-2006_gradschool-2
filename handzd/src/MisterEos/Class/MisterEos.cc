...
//
static const char* const kFacilityString = "Processor.MisterEos" ;
...
//
MisterEos::MisterEos( void )               // anal1
   : Processor( "MisterEos" )
{
   ...
   bind( &MisterEos::event,    Stream::kEvent );
   //bind( &MisterEos::beginRun, Stream::kBeginRun );
   //bind( &MisterEos::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
MisterEos::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
MisterEos::terminate( void )     // anal5 "Interactive"
{
...
void
MisterEos::hist_book( HIHistoManager& iHistoManager )
{
...
MisterEos::event( Frame& iFrame )          // anal3 equiv.
{
...
/*
ActionBase::ActionResult
MisterEos::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
MisterEos::endRun( Frame& iFrame )         // anal4 equiv.
{
