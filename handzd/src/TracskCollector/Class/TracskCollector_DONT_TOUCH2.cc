...
// Module:      TracskCollector_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TracskCollector:
//              creates a new TracskCollector instance each time 
