...
// $Id: ZDAlignmentBhabhaFilterProc.cc,v 1.1.1.1 2003/12/05 17:54:58 mccann Exp $
//
// Revision history
//
// $Log: ZDAlignmentBhabhaFilterProc.cc,v $
...
//
static const char* const kFacilityString = "Processor.ZDAlignmentBhabhaFilterProc" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: ZDAlignmentBhabhaFilterProc.cc,v 1.1.1.1 2003/12/05 17:54:58 mccann Exp $";
...
//
ZDAlignmentBhabhaFilterProc::ZDAlignmentBhabhaFilterProc( void )               // anal1
   : Processor( "ZDAlignmentBhabhaFilterProc" )
   ...
   , m_asymmetric_beamz("asymmetricBeamZ", this, 0.)
{
   ...
   bind( &ZDAlignmentBhabhaFilterProc::event,    Stream::kEvent );
   //bind( &ZDAlignmentBhabhaFilterProc::beginRun, Stream::kBeginRun );
   //bind( &ZDAlignmentBhabhaFilterProc::endRun,   Stream::kEndRun );
...
ZDAlignmentBhabhaFilterProc::~ZDAlignmentBhabhaFilterProc()                    // anal5
{
...
// --------------------------- init method -------------------------
void
ZDAlignmentBhabhaFilterProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
ZDAlignmentBhabhaFilterProc::terminate( void )     // anal5 "Interactive"
{
...
void
ZDAlignmentBhabhaFilterProc::hist_book( HIHistoManager& iHistoManager )
{
...
ZDAlignmentBhabhaFilterProc::event( Frame& iFrame )          // anal3 equiv.
{
...
/*
ActionBase::ActionResult
ZDAlignmentBhabhaFilterProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
ZDAlignmentBhabhaFilterProc::endRun( Frame& iFrame )         // anal4 equiv.
{
