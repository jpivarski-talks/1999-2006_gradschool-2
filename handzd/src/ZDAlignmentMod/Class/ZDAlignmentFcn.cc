...
// $Id: ZDAlignmentFcn.cc,v 1.1.1.1 2003/12/05 23:20:01 mccann Exp $
//
// Revision history
//
// $Log: ZDAlignmentFcn.cc,v $
...
static const char* const kIdString  = "$Id: ZDAlignmentFcn.cc,v 1.1.1.1 2003/12/05 23:20:01 mccann Exp $";
