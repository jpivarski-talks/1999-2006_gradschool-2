...
// $Id: ZDAlignmentMod.cc,v 1.1.1.1 2003/12/05 23:20:00 mccann Exp $
//
// Revision history
//
// $Log: ZDAlignmentMod.cc,v $
...
static const char* const kIdString  = "$Id: ZDAlignmentMod.cc,v 1.1.1.1 2003/12/05 23:20:00 mccann Exp $";
