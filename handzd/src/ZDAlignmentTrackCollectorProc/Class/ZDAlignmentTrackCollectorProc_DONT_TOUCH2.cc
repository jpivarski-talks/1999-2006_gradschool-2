...
// Module:      ZDAlignmentTrackCollectorProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor ZDAlignmentTrackCollectorProc:
//              creates a new ZDAlignmentTrackCollectorProc instance each time 
...
makeProcessor( void )
{
   return new ZDAlignmentTrackCollectorProc;
}
