...
static const char* const kFacilityString = "ZDHitStudy.MyDualTrackConstraint" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: MyDualTrackConstraint.cc,v 1.5 2001/08/24 21:40:21 wsun Exp $";
...
//
MyDualTrackConstraint::MyDualTrackConstraint(
...
// MyDualTrackConstraint::MyDualTrackConstraint( const MyDualTrackConstraint& rhs )
// {
...
//
// const MyDualTrackConstraint& MyDualTrackConstraint::operator=( const MyDualTrackConstraint& rhs )
// {
//   if( this != &rhs ) {
...
HepVector
MyDualTrackConstraint::constraint(
...
HepMatrix
MyDualTrackConstraint::constraintDerivatives( 
   const STL_VECTOR( HIFitHelix* )& aHelices ) const
{
   assert( aHelices.size() == 2 ) ;
   assert( aHelices[0]->referencePoint() == aHelices[1]->referencePoint() );
