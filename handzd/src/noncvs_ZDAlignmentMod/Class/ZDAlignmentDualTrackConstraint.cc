...
//
// Author:      Jim Pivarski
// Created:     Tue Dec  2 15:15:22 EST 2003
// $Id:
//
// Revision history
//
...
static const char* const kFacilityString = "ZDAlignmentMod.ZDAlignmentDualTrackConstraint" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: ZDAlignmentDualTrackConstraint.cc,v 1.5 2001/08/24 21:40:21 wsun Exp $";
static const char* const kTagString = "$Name: v13_04_01 $";
...
//
ZDAlignmentDualTrackConstraint::ZDAlignmentDualTrackConstraint(
...
// ZDAlignmentDualTrackConstraint::ZDAlignmentDualTrackConstraint( const ZDAlignmentDualTrackConstraint& rhs )
// {
...
//
// const ZDAlignmentDualTrackConstraint& ZDAlignmentDualTrackConstraint::operator=( const ZDAlignmentDualTrackConstraint& rhs )
// {
//   if( this != &rhs ) {
...
HepVector
ZDAlignmentDualTrackConstraint::constraint(
...
HepMatrix
ZDAlignmentDualTrackConstraint::constraintDerivatives( 
   const STL_VECTOR( HIFitHelix* )& aHelices ) const
{
   assert( aHelices.size() == 2 ) ;
   assert( aHelices[0]->referencePoint() == aHelices[1]->referencePoint() );
