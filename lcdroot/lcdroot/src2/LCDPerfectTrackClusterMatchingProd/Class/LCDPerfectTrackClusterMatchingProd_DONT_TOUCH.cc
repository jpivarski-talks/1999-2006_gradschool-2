...
// Module:      LCDPerfectTrackClusterMatchingProd_DONT_TOUCH
// 
// Description: DONT TOUCH THIS FILE
//
//              Factory method to create processor LCDPerfectTrackClusterMatchingProd:
//              creates a new LCDPerfectTrackClusterMatchingProd instance each time 
...
makeProducer( void )
{
   return new LCDPerfectTrackClusterMatchingProd;
}
