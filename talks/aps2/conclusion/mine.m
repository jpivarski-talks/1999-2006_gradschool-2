...
Show[
	...
	{Thickness[0.002],
	 RGBColor[1, 0, 0],
	 Line[{Offset[{3.0, 0}, {f[2.0], 0.447746 * 0.890823828845}],
	       Offset[{-3.0, 0}, {f[2.0], 0.447746 * 0.890823828845}]}],
	 Line[{Offset[{3.0, 0}, {f[2.0], 0.43625400000000003 * 0.890823828845}],
	       Offset[{-3.0, 0}, {f[2.0], 0.43625400000000003 * 0.890823828845}]}],
	 Thickness[0.002],
	 RGBColor[0, 0, 1],
