...
//
// Author:      Jim Pivarski
// Created:     Tue Jun  7 10:22:19 EDT 2005
// $Id$
//
// Revision history
//
...
//
static const char* const kFacilityString = "Processor.MyFirstProc" ;
...
//
MyFirstProc::MyFirstProc( void )               // anal1
   : Processor( "MyFirstProc" )
{
   ...
   bind( &MyFirstProc::event,    Stream::kEvent );
   //bind( &MyFirstProc::beginRun, Stream::kBeginRun );
   //bind( &MyFirstProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
MyFirstProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
MyFirstProc::terminate( void )     // anal5 "Interactive"
{
...
void
MyFirstProc::hist_book( HIHistoManager& iHistoManager )
{
   report( DEBUG, kFacilityString ) << "here in hist_book()" << endl;

   // book your histograms here
   m_histo1 = iHistoManager.histogram( "Event Number" ,
                                       12000          ,
                                       0              ,
                                       120000         );
...
MyFirstProc::event( Frame& iFrame )          // anal3 equiv.
{
   ...
   (*m_histo1).fill( (*eventHeader).number() );
...
/*
ActionBase::ActionResult
MyFirstProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
MyFirstProc::endRun( Frame& iFrame )         // anal4 equiv.
{
