...
// Module:      FindTwoPhoton_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor FindTwoPhoton:
//              creates a new FindTwoPhoton instance each time 
