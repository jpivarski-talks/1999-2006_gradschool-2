...
// Module:      PlotCalorimeter_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor PlotCalorimeter:
//              creates a new PlotCalorimeter instance each time 
