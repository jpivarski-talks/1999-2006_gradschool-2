...
\vfill
\begin{center}
  \fbox{\includegraphics[height=1.5 cm]{title_GeeU}}
\end{center}
...
\[ \Gamma_{ee} = \Gamma \times \mathcal{B}_{ee} \mbox{ where $\Gamma$ is the resonance width} \]
  ...
  \begin{center}
    \begin{tabular}{p{10 cm} c p{10 cm}}
      ...
      \begin{minipage}{\linewidth} \begin{center}
  	\mbox{\hspace{-1 cm}} \includegraphics[width=10 cm]{diagram_GeeU-reversed}
...
\begin{itemize}
  ...
  \item Beam-energy measurement {\bf in}stability $\lesssim$ 0.07 MeV
...
\begin{center}
  ...
  \begin{tabular}{l c c c}
    ...
    Luminosity calibration        & {\color{red} 1.3\%}  & {\color{red} 1.3\%}  & {\color{red} 1.3\%} \\
...
\begin{itemizer}{0.5 cm}
  ...
  \item But we can compare {\it ratio} of $\Gamma_{ee}(2S)/\Gamma_{ee}(1S)$ (missing factors cancel)
...
\begin{center}
  \begin{tabular}{p{5 cm} p{1 cm} p{5 cm}}
    \mbox{\begin{minipage}{\linewidth} \includegraphics[width=\linewidth, trim=0 2.2cm 0 2.2cm, clip=true]{../fuzzyloose-digital} \end{minipage}} & \mbox{\begin{minipage}{\linewidth} vs \end{minipage}} & \mbox{\begin{minipage}{\linewidth} \includegraphics[width=\linewidth, trim=0 2.2cm 0 2.2cm, clip=true]{../fuzzyloose} \end{minipage}}
  \end{tabular}
\end{center}

  \vspace{0.25 cm}
  \item $Z_{match}$ is the missing factor, it contains discrete $\to$ continuum matching
...
\begin{itemizer}{1 cm}
  ...
  \item Improvement to experiment:

  \begin{itemizer}{0.5 cm}

    \item If we measure point-by-point luminosity with $e^+e^-$ rather
    than $\gamma\gamma$, we can gain a factor of two in statistical uncertainty

    \item This would especially help ratios, which are statistically-limited

    \item But this may introduce systematic error

  \end{itemizer}

  \item Improvements to theory are forthcoming
...
\begin{itemizer}{0.5 cm}
  ...
  \item 2\% systematic uncertainty, 15\% statistical uncertainty

  \item $\mathcal{B}(D^+ \to \mu^+\nu)$ = (4.40 $\pm$ 0.66 $^{{\mathsf{+0.09}}}_{{\mathsf{-0.12}}}$) $\times$ 10$^{{\mathsf{-4}}}$

  \item  $f_{D^+}$ = (222.6 $\pm$ 16.7 $^{{\mathsf{+2.8}}}_{{\mathsf{-3.4}}}$) MeV
