...
g1["CLEO-III '05"] = 1.235, 0.009, 0.017
...
g2["CLEO-III '05"] = 0.579, 0.009, 0.008
...
g3["CLEO-III '05"] = 0.394, 0.009, 0.006
...
p[0,0].add(biggles.LineX(1.216, linetype="longdashed", linecolor="grey"))
p[0,0].add(biggles.LineX(1.216+0.027, linetype="dotted", linecolor="grey"))
p[0,0].add(biggles.LineX(1.216-0.027, linetype="dotted", linecolor="grey"))
...
p[0,1].add(biggles.LineX(0.553, linetype="longdashed", linecolor="grey"))
p[0,1].add(biggles.LineX(0.553+0.023, linetype="dotted", linecolor="grey"))
p[0,1].add(biggles.LineX(0.553-0.023, linetype="dotted", linecolor="grey"))
...
p[0,2].add(biggles.LineX(0.45, linetype="longdashed", linecolor="grey"))
p[0,2].add(biggles.LineX(0.45+0.0424, linetype="dotted", linecolor="grey"))
p[0,2].add(biggles.LineX(0.45-0.0424, linetype="dotted", linecolor="grey"))
