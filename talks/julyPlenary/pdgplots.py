...
p[0,0].add(biggles.Points(y,x, symboltype="filled circle", symbolsize=1.5, color="black"))
p[0,0].add(biggles.SymmetricErrorBarsX(y,x,yerr1, color="black"))
p[0,0].add(biggles.SymmetricErrorBarsX(y,x,yerr2, color="black"))
# p[0,0].x.range = 1.216-5.*0.027, 1.216+5.*0.027
p[0,0].x1.range = 0.85*1.216, 1.15*1.216
p[0,0].x1.ticks = 1.1, 1.2, 1.3
p[0,0].x2.range = -15, 15
p[0,0].x2.ticks = -15, -10, -5, 0, 5, 10, 15
p[0,0].x2.draw_ticklabels = 1
...
p[0,1].add(biggles.Points(y,x, symboltype="filled circle", symbolsize=1.5, color="black"))
p[0,1].add(biggles.SymmetricErrorBarsX(y,x,yerr1, color="black"))
p[0,1].add(biggles.SymmetricErrorBarsX(y,x,yerr2, color="black"))
# p[0,1].x.range = 0.553-5.*0.023, 0.553+5.*0.023
p[0,1].x1.range = 0.85*0.553, 1.15*0.553
p[0,1].x1.ticks = 0.5, 0.55, 0.6
p[0,1].x2.range = -15, 15
p[0,1].x2.ticks = -15, -10, -5, 0, 5, 10, 15
p[0,1].x2.draw_ticklabels = 1
...
p[0,2].add(biggles.Points(y,x, symboltype="filled circle", symbolsize=1.5, color="black"))
p[0,2].add(biggles.SymmetricErrorBarsX(y,x,yerr1, color="black"))
p[0,2].add(biggles.SymmetricErrorBarsX(y,x,yerr2, color="black"))
# p[0,2].x.range = 0.45-5.*0.0424, 0.45+5.*0.0424
p[0,2].x1.range = 0.85*0.45, 1.15*0.45
p[0,2].x1.ticks = 0.4, 0.45, 0.5
p[0,2].x2.range = -15, 15
p[0,2].x2.ticks = -15, -10, -5, 0, 5, 10, 15
p[0,2].x2.draw_ticklabels = 1
